          ...
          Column(children: [
            Row(
              ...
              children: [
                Checkbox(
                  ...
                  activeColor: Color.fromRGBO(140, 24, 68, 1),
                ),
                Text(productos[0].id, style: TextStyle(color: Colors.black)),
            ...
            Row(
              ...
              children: [
                ...
                Text(productos[1].id, style: TextStyle(color: Colors.black)),
